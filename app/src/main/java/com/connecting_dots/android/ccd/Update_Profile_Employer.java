...
public class Update_Profile_Employer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((EditText)findViewById(R.id.name)).setText(MyApplication.getInstance(Update_Profile_Employer.this.getApplicationContext()).getUsername());
        ((EditText)findViewById(R.id.phone)).setText(MyApplication.getInstance(Update_Profile_Employer.this.getApplicationContext()).getPhoneNo());
        ((EditText)findViewById(R.id.job)).setText(MyApplication.getInstance(Update_Profile_Employer.this.getApplicationContext()).getProfession());

        TextView typeView = (TextView) findViewById(R.id.type);
        typeView.setText(MyApplication.getInstance(Update_Profile_Employer.this.getApplicationContext()).getType());
    ...
    private void uploadData(){
        class updateProfile extends AsyncTask<Bitmap,Void,String> {
            ...
            protected String doInBackground(Bitmap... params) {
                ...
                data.put("IMEI",MyApplication.getInstance(Update_Profile_Employer.this.getApplicationContext()).getID());
                data.put("name",name);
